  ...
  return (
    <Route>
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="h=[80%] w=[98%] rounded-"> <img src="https://i.pinimg.com/originals/f1/2c/8d/f12c8df7accde83f5e4e04bbc194f90d.jpg" alt="" className="h-full w-full rounded-xl  py-4"/></div>
