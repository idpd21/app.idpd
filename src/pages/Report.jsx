      ...
      <div className="p-6 h-screen">
        ...
        <div className="grid grid-cols-4 gap-4 pb-4">
          <div className="p-4 bg-blue-100 border border-blue-300 rounded-lg">
            <h2 className="text-lg font-semibold">ຍອດຂາຍລວມ</h2>
            <p className="text-2xl font-bold text-blue-600 text-end">
              {summary.totalSales
          ...
          <div className="p-4 bg-green-100 border border-green-300 rounded-lg">
            <h2 className="text-lg font-semibold">ລາຍຮັບລວມ</h2>
            <p className="text-2xl font-bold text-green-600 text-end">
              {summary.totalIncome
          ...
          <div className="p-4 bg-red-100 border border-red-300 rounded-lg">
            <h2 className="text-lg font-semibold">ລາຍຈ່າຍລວມ</h2>
            <p className="text-2xl font-bold text-red-600 text-end">
          ...
          <div className="p-4 bg-yellow-100 border border-yellow-300 rounded-lg">
            <h2 className="text-lg font-semibold">ກຳໄລ</h2>
            <p className="text-2xl font-bold text-yellow-600 text-end">
